const project_collection_name = "Schnitzler-Mikrofilme"
...
search.addWidgets([
    ...
    instantsearch.widgets.sortBy({
        container: "#sort-by",
        items: [
            { label: "Standard", value: "Schnitzler-Mikrofilme" },
            { label: "ID (aufsteigend)", value: "Schnitzler-Mikrofilme/sort/rec_id:asc" },
            { label: "ID (absteigend)", value: "Schnitzler-Mikrofilme/sort/rec_id:desc" },
        ],
    }),
